...
public class DBManager {
	...
	public void startHsqlDb(){
    	 try {
     		...
     		if(server==null){
               props.setProperty("server.database.0", "file:C:\\Users\\Administrator\\git\\TestDDD\\TestDDD-Spring-Hibernate\\mydb\\hsqldb17;");
               props.setProperty("server.trace", "true");
               props.setProperty("server.silent", "false");
               props.setProperty("server.dbname.0", "hsqldb17");
